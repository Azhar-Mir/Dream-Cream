...
public class AdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.FrameLayout,new com.example.dream_cream.UI.ProductsFragment()).commit();
            ...
            new BottomNavigationView.OnNavigationItemSelectedListener() {
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    ...
                    if(id==R.id.ProductID){
                        SelectedFragment = new com.example.dream_cream.UI.ProductsFragment();
                        FragmentTitle.setText("All Products");
                    }
                    else if(id==R.id.OffersID){
                        SelectedFragment = new com.example.dream_cream.UI.OffersFragment();
                        FragmentTitle.setText("All Offers");
                    }
                    else if(id==R.id.SalesMenID){
                        SelectedFragment = new com.example.dream_cream.UI.SalesMenFragment();
    ...
    private void CheckLogout(){
        AlertDialog.Builder checkAlert = new AlertDialog.Builder(com.example.dream_cream.UI.AdminActivity.this);
        checkAlert.setMessage("Do you want to Logout?")
                .setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                mAuth.signOut();
                Intent intent=new Intent(com.example.dream_cream.UI.AdminActivity.this, com.example.dream_cream.UI.loginActivity.class);
