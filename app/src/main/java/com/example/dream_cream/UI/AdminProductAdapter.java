...
public class AdminProductAdapter extends RecyclerView.Adapter<com.example.dream_cream.UI.AdminProductAdapter.ProductViewHolder> {
    ...
    public AdminProductAdapter(Context context, List<com.example.dream_cream.UI.AdminProduct> adminProducts) {
        this.context = context;
        this.adminProducts = adminProducts;
    }

    public void addList(List<com.example.dream_cream.UI.AdminProduct> list)
    {
        adminProducts.clear();
    ...
    public void onBindViewHolder(@NonNull ProductViewHolder holder, int position) {
        ...
        holder.expire.setText("Info: "+adminProducts.get(position).getExpired());
