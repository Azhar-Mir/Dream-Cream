...
public class AdminSalesManAdapter extends RecyclerView.Adapter<com.example.dream_cream.UI.AdminSalesManAdapter.SalesManViewHolder> {
    private Context context;
    private List<com.example.dream_cream.UI.AdminSalesMan> salesManList;
    ...
    public AdminSalesManAdapter(Context context, List<com.example.dream_cream.UI.AdminSalesMan> salesManList) {
        this.context = context;
        this.salesManList = salesManList;
    }

    public void addList(List<com.example.dream_cream.UI.AdminSalesMan> list)
    {
        salesManList.clear();
