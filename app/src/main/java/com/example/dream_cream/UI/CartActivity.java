...
public class CartActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id==R.id.Home){
            startActivity(new Intent(com.example.dream_cream.UI.CartActivity.this,MainActivity.class));
        }
        else if(id==R.id.Profile){
            startActivity(new Intent(com.example.dream_cream.UI.CartActivity.this,UserProfileActivity.class));
        }
        else if(id == R.id.favourites){
            startActivity(new Intent(com.example.dream_cream.UI.CartActivity.this, favourites_activity.class));
        }
        else if(id == R.id.MyOrders){
            startActivity(new Intent(com.example.dream_cream.UI.CartActivity.this, OrderActivity.class));
        }
        else if(id==R.id.fruits){
            Intent intent =new Intent(com.example.dream_cream.UI.CartActivity.this,CategoryActivity.class);
    ...
    private void CheckLogout(){
        AlertDialog.Builder checkAlert = new AlertDialog.Builder(com.example.dream_cream.UI.CartActivity.this);
        checkAlert.setMessage("Do you want to Logout?")
                .setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                FirebaseAuth.getInstance().signOut();
                Intent intent=new Intent(com.example.dream_cream.UI.CartActivity.this, com.example.dream_cream.UI.loginActivity.class);
                startActivity(intent);
                finish();
            }
