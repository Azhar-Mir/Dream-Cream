...
public class CartAdapter extends RecyclerView.Adapter  {
    private  List<com.example.dream_cream.UI.CartItemModel> cartItemModelList;
    ...
    public CartAdapter(List<com.example.dream_cream.UI.CartItemModel> cartItemModelList) {
    ...
    public int getItemViewType(int position) {
        ...
        {
            case 0:
                return  com.example.dream_cream.UI.CartItemModel.cart_item;
            default:
                return  -1;
        }
    }
    ...
    class cartItemViewHolder extends RecyclerView.ViewHolder  {
        ...
        public cartItemViewHolder(@NonNull View itemView  ,final com.example.dream_cream.UI.CartAdapter.OnItemClickListener listener) {
            super(itemView);
