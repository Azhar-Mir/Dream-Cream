...
public class CategoryActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private ArrayList<com.example.dream_cream.UI.CategoryProductInfo> CategoryProducts;
    ...
    private void onClickAnyProduct(){
        listener = new CategoryProductInfoAdapter.RecyclerViewClickListener() {
            ...
            public void onClick(View view, int position) {
                com.example.dream_cream.UI.CategoryProductInfo product = CategoryProducts.get(position);

                Intent intent = new Intent(com.example.dream_cream.UI.CategoryActivity.this, com.example.dream_cream.UI.ProductInfoActivity.class);
                ...
                intent.putExtra("Info",product.getProductExpiryDate());
    ...
    private void setCategoryData(){
        ...
        adapter = new CategoryProductInfoAdapter(com.example.dream_cream.UI.CategoryActivity.this,CategoryProducts,listener);
        recyclerView.setLayoutManager(new LinearLayoutManager(com.example.dream_cream.UI.CategoryActivity.this));
                ...
                if(snapshot.exists()){
                    for(DataSnapshot dataSnapshot : snapshot.getChildren()){
                        ...
                        ValueEventListener vvalueEventListener = new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if(snapshot.exists()){
                                    CategoryProducts.add(new com.example.dream_cream.UI.CategoryProductInfo(ProductImage,ProductName,ProductPrice,ProductExpiryDate,true));
                                }
                                else{
                                    CategoryProducts.add(new com.example.dream_cream.UI.CategoryProductInfo(ProductImage,ProductName,ProductPrice,ProductExpiryDate,false));
                                }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if(id==R.id.Home){
            startActivity(new Intent(com.example.dream_cream.UI.CategoryActivity.this,MainActivity.class));
        }
        else if(id==R.id.Profile){
            startActivity(new Intent(com.example.dream_cream.UI.CategoryActivity.this,UserProfileActivity.class));
        }
        else if(id == R.id.Cart){
            startActivity(new Intent(com.example.dream_cream.UI.CategoryActivity.this, com.example.dream_cream.UI.CartActivity.class));
        }
        else if(id == R.id.MyOrders){
            startActivity(new Intent(com.example.dream_cream.UI.CategoryActivity.this, OrderActivity.class));
        }
        else if(id == R.id.favourites){
            startActivity(new Intent(com.example.dream_cream.UI.CategoryActivity.this, favourites_activity.class));
        }
    ...
    private void CheckLogout(){
        AlertDialog.Builder checkAlert = new AlertDialog.Builder(com.example.dream_cream.UI.CategoryActivity.this);
        checkAlert.setMessage("Do you want to Logout?")
                .setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                FirebaseAuth.getInstance().signOut();
                Intent intent=new Intent(com.example.dream_cream.UI.CategoryActivity.this, com.example.dream_cream.UI.loginActivity.class);
                startActivity(intent);
                finish();
            }
