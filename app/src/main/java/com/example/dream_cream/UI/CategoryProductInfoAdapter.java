...
public class CategoryProductInfoAdapter extends RecyclerView.Adapter<com.example.dream_cream.UI.CategoryProductInfoAdapter.ViewHolder> {
    ...
    private List<com.example.dream_cream.UI.CategoryProductInfo> ProductList;

    public CategoryProductInfoAdapter(Context context, List<com.example.dream_cream.UI.CategoryProductInfo> ProductList, RecyclerViewClickListener listener){
    ...
    @Override
    public void onBindViewHolder(@NonNull final com.example.dream_cream.UI.CategoryProductInfoAdapter.ViewHolder holder, int position) {
        final com.example.dream_cream.UI.CategoryProductInfo product = ProductList.get(position);
        ...
        holder.ProductExpiryDate.setText("Info: "+product.getProductExpiryDate());
