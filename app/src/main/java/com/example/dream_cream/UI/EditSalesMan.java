...
public class EditSalesMan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        httpsRef.getBytes(ONE_MEGABYTE).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(com.example.dream_cream.UI.EditSalesMan.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mUploadTask != null && mUploadTask.isInProgress())
                    Toast.makeText(com.example.dream_cream.UI.EditSalesMan.this, "Upload Is In Progress", Toast.LENGTH_SHORT).show();
                else {
                    AlertDialog.Builder dialog = new AlertDialog.Builder(com.example.dream_cream.UI.EditSalesMan.this).setTitle("Confirmation").setMessage("Are You Sure You Want To Save ?!").setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        @Override
    ...
    public void uploadData()
    {
        ...
        {
            Toast.makeText(com.example.dream_cream.UI.EditSalesMan.this, "Empty Cells", Toast.LENGTH_SHORT).show();
        }
        else
            uploadImage();
    }
    ...
    public void uploadQr()
    {
        ...
        mUploadTask = fileReference.putBytes(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(com.example.dream_cream.UI.EditSalesMan.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
