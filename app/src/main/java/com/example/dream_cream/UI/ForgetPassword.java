                    ...
                    mfirebaseAuth.sendPasswordResetEmail(emailTxt.getText().toString())
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if(task.isSuccessful())
                                Toast.makeText(com.example.dream_cream.UI.ForgetPassword.this, "Password has been sent to your email please check your inbox", Toast.LENGTH_LONG).show();
                            else
                                Toast.makeText(com.example.dream_cream.UI.ForgetPassword.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                else
