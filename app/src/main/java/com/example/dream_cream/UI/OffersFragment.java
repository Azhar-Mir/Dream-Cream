...
public class OffersFragment extends Fragment {
    ...
    public static com.example.dream_cream.UI.OffersFragment newInstance(String param1, String param2) {
        com.example.dream_cream.UI.OffersFragment fragment = new com.example.dream_cream.UI.OffersFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter.setOnItemClickListener(new AdminOfferAdapter.onItemClickListener() {
            ...
            public void onItemClick(int pos) {
                Intent i = new Intent(getActivity() , com.example.dream_cream.UI.EditOffer.class);
                Bundle b = new Bundle();
