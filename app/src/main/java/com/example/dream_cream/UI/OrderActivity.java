...
public class OrderActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id==R.id.Home){
            startActivity(new Intent(com.example.dream_cream.UI.OrderActivity.this,MainActivity.class));
        }
        else if(id==R.id.Profile){
            startActivity(new Intent(com.example.dream_cream.UI.OrderActivity.this,UserProfileActivity.class));
        }
        else if(id == R.id.favourites){
            startActivity(new Intent(com.example.dream_cream.UI.OrderActivity.this, favourites_activity.class));
        }
        else if(id == R.id.Cart){
            startActivity(new Intent(com.example.dream_cream.UI.OrderActivity.this, CartActivity.class));
        }
        else if(id==R.id.fruits){
            Intent intent =new Intent(com.example.dream_cream.UI.OrderActivity.this, com.example.dream_cream.UI.CategoryActivity.class);
    ...
    private void CheckLogout(){
        AlertDialog.Builder checkAlert = new AlertDialog.Builder(com.example.dream_cream.UI.OrderActivity.this);
        checkAlert.setMessage("Do you want to Logout?")
                .setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                FirebaseAuth.getInstance().signOut();
                Intent intent=new Intent(com.example.dream_cream.UI.OrderActivity.this,loginActivity.class);
                startActivity(intent);
                finish();
            }
