...
public class OrderFregmant extends Fragment {
    ...
    ArrayList<com.example.dream_cream.UI.MyorderModel> orderItemList;
    com.example.dream_cream.UI.OrderAdapter adapter ;
    ...
    public static com.example.dream_cream.UI.OrderFregmant newInstance(String param1, String param2) {
        com.example.dream_cream.UI.OrderFregmant fragment = new com.example.dream_cream.UI.OrderFregmant();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        orderItemList = new ArrayList<com.example.dream_cream.UI.MyorderModel>();
        adapter = new com.example.dream_cream.UI.OrderAdapter(getActivity(),orderItemList);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        ...
                        orderItemList.add( new com.example.dream_cream.UI.MyorderModel(dataSnapshot.getKey(),"   Date :  " + Date ,"   Products Number :  "+String.valueOf(nums),"   Total Price :  "+ totalPrice+" Rs" , "   "+products,OrderCheck));
                    }
                }
                else{
                    orderItemList.clear();
