...
public class ProductInfoActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProductNExpiryDate= getIntent().getStringExtra("Info");
    ...
    private void onClicking(){
        ...
        Confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DeleteFromCartContainer.setVisibility(View.VISIBLE);
                AddToCartContainer.setVisibility(View.GONE);
                Toast.makeText(com.example.dream_cream.UI.ProductInfoActivity.this,"The Product Added Successfully to your Cart",Toast.LENGTH_SHORT).show();
        ...
        DeleteFromCartContainer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(com.example.dream_cream.UI.ProductInfoActivity.this,"The Product Deleted Successfully from your Cart",Toast.LENGTH_SHORT).show();
    ...
    private void setProductData(){
        ...
        else {PExpiryDate.setVisibility(View.VISIBLE); PExpiryDate.setText("Info: "+ProductNExpiryDate);}
        ...
        ValueEventListener valueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    for(DataSnapshot dataSnapshot : snapshot.child("Cookies").getChildren()){
                        if(dataSnapshot.getKey().equals(ProductName)){
                            PCategory.setText("Category: Cookies");
                            PAmount.setText("Available Amounts: "+dataSnapshot.child("quantity").getValue());
                            break;}
                    }
                    for(DataSnapshot dataSnapshot : snapshot.child("Cakes").getChildren()){
                        if(dataSnapshot.getKey().equals(ProductName)){
                            PCategory.setText("Category: Cakes");
                            PAmount.setText("Available Amounts: "+dataSnapshot.child("quantity").getValue());
                            break;}
                    }

                    for(DataSnapshot dataSnapshot : snapshot.child("Breads").getChildren()){
                        if(dataSnapshot.getKey().equals(ProductName)){
                            PCategory.setText("Category: Breads");
                            PAmount.setText("Available Amounts: "+dataSnapshot.child("quantity").getValue());
                            break;}
                    }

                    for(DataSnapshot dataSnapshot : snapshot.child("Muffins").getChildren()){
                        if(dataSnapshot.getKey().equals(ProductName)){
                            PCategory.setText("Category: Muffins");
                            PAmount.setText("Available Amounts: "+dataSnapshot.child("quantity").getValue());
                            break;}
                    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if(id==R.id.Home){
            startActivity(new Intent(com.example.dream_cream.UI.ProductInfoActivity.this,MainActivity.class));
        }
        else if(id==R.id.Profile){
            startActivity(new Intent(com.example.dream_cream.UI.ProductInfoActivity.this,UserProfileActivity.class));
        }
        else if(id == R.id.favourites){
            startActivity(new Intent(com.example.dream_cream.UI.ProductInfoActivity.this, favourites_activity.class));
        }
        else if(id == R.id.Cart){
            startActivity(new Intent(com.example.dream_cream.UI.ProductInfoActivity.this, CartActivity.class));
        }
        else if(id == R.id.MyOrders){
            startActivity(new Intent(com.example.dream_cream.UI.ProductInfoActivity.this, OrderActivity.class));
        }
        else if(id == R.id.Support){
            startActivity(new Intent(com.example.dream_cream.UI.ProductInfoActivity.this, SupportActivity.class));
        }
        else if(id==R.id.fruits){
            Intent intent =new Intent(com.example.dream_cream.UI.ProductInfoActivity.this,CategoryActivity.class);
    ...
    private void CheckLogout(){
        AlertDialog.Builder checkAlert = new AlertDialog.Builder(com.example.dream_cream.UI.ProductInfoActivity.this);
        checkAlert.setMessage("Do you want to Logout?")
                .setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                FirebaseAuth.getInstance().signOut();
                Intent intent=new Intent(com.example.dream_cream.UI.ProductInfoActivity.this,loginActivity.class);
                startActivity(intent);
                finish();
            }
