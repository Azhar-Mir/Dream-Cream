...
public class ProductsFragment extends Fragment {
    ...
    private com.example.dream_cream.UI.AdminProductAdapter adapter;
    private FloatingActionButton ProductsFloatingActionButton;
    private List<com.example.dream_cream.UI.AdminProduct> adminProducts;
    ...
    public static com.example.dream_cream.UI.ProductsFragment newInstance(String param1, String param2) {
        com.example.dream_cream.UI.ProductsFragment fragment = new com.example.dream_cream.UI.ProductsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new com.example.dream_cream.UI.AdminProductAdapter(getActivity(),adminProducts);
        ...
        mDataBaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot snapshot1:snapshot.getChildren())//category
                {
                    ...
                    {
                        adminProducts.add(new com.example.dream_cream.UI.AdminProduct(snapshot2.getKey() ,
                                snapshot1.getKey() ,
        ...
        ProductsFloatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //here add button
                startActivity(new Intent(getActivity(), com.example.dream_cream.UI.AddProduct.class));
