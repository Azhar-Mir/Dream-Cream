...
public class SalesMenFragment extends Fragment {
    ...
    private com.example.dream_cream.UI.AdminSalesManAdapter adapter;
    private FloatingActionButton SalesFloatingActionButton;
    private List<com.example.dream_cream.UI.AdminSalesMan> adminSalesManList;
    ...
    public static com.example.dream_cream.UI.SalesMenFragment newInstance(String param1, String param2) {
        com.example.dream_cream.UI.SalesMenFragment fragment = new com.example.dream_cream.UI.SalesMenFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new com.example.dream_cream.UI.AdminSalesManAdapter(getActivity(),adminSalesManList);
        ...
        mDataBaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                {
                    adminSalesManList.add(new com.example.dream_cream.UI.AdminSalesMan(snapshot1.getKey() ,
        ...
        adapter.setOnItemClickListener(new AdminOfferAdapter.onItemClickListener() {
            ...
            public void onItemClick(int pos) {
                Intent i = new Intent(getActivity() , com.example.dream_cream.UI.EditSalesMan.class);
                Bundle b = new Bundle();
