...
public class ScanQRCodeActivity extends AppCompatActivity {
    ...
    private void requestForCamera() {
        Dexter.withActivity(com.example.dream_cream.UI.ScanQRCodeActivity.this).withPermission(Manifest.permission.CAMERA).withListener(new PermissionListener() {
            @Override
            ...
            public void onPermissionDenied(PermissionDeniedResponse response) {
                Toast.makeText(com.example.dream_cream.UI.ScanQRCodeActivity.this,"Camera Permission is Requested",Toast.LENGTH_LONG).show();
                finish();
            }
            @Override
        ...
        ValueEventListener valueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.exists()){
                    ...
                    Toast.makeText(com.example.dream_cream.UI.ScanQRCodeActivity.this,"Order Received Successfully",Toast.LENGTH_LONG).show();
                    com.example.dream_cream.UI.OrderFregmant.fa.finish();
                    finish();
                }
                else {
