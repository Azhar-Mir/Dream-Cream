...
public class SupportActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private TextView PageTitle,textView1,textView2,textView3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView1 = (TextView) findViewById(R.id.faqs);
        ...
        textView1 = (TextView) findViewById(R.id.contactus);
        textView1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SupportActivity.this, ContactActivity.class);
                startActivity(intent);
                finish();
            }
        });

        textView3 = (TextView) findViewById(R.id.feedback);
        ...
        mToolbar = (Toolbar)findViewById(R.id.supporttoobar);
        setSupportActionBar(mToolbar);
        getSupportActionBar().setTitle("Help & Support");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        //getSupportFragmentManager().beginTransaction().replace(R.id.helpsupport,new MyCartFragment()).commit();
    }

    @Override
    protected void onStart() {
        super.onStart();
        drawerLayout = (DrawerLayout) findViewById(R.id.supportDrawer);
        navigationView = (NavigationView) findViewById(R.id.supportNavigationViewer);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id== R.id.Home){
            ...
            startActivity(new Intent(SupportActivity.this, favourites_activity.class));
        }
        else if(id == R.id.MyOrders){
            startActivity(new Intent(SupportActivity.this, OrderActivity.class));
        }
        else if(id== R.id.fruits){
            Intent intent =new Intent(SupportActivity.this, CategoryActivity.class);
    ...
    private void CheckLogout(){
        AlertDialog.Builder checkAlert = new AlertDialog.Builder(SupportActivity.this);
