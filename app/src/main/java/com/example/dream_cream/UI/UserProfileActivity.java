...
public class UserProfileActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserFavorites.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(com.example.dream_cream.UI.UserProfileActivity.this, com.example.dream_cream.UI.favourites_activity.class));
            }
        });
        ...
        UserOrders.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(com.example.dream_cream.UI.UserProfileActivity.this, com.example.dream_cream.UI.OrderActivity.class));
            }
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        if(id==R.id.Home){
            startActivity(new Intent(com.example.dream_cream.UI.UserProfileActivity.this, com.example.dream_cream.UI.MainActivity.class));
        }
        else if(id == R.id.favourites){
            startActivity(new Intent(com.example.dream_cream.UI.UserProfileActivity.this, com.example.dream_cream.UI.favourites_activity.class));
        }
        else if(id == R.id.Cart){
            startActivity(new Intent(com.example.dream_cream.UI.UserProfileActivity.this, com.example.dream_cream.UI.CartActivity.class));
        }
        else if(id == R.id.MyOrders){
            startActivity(new Intent(com.example.dream_cream.UI.UserProfileActivity.this, com.example.dream_cream.UI.OrderActivity.class));
        }
        else if(id==R.id.fruits){
            Intent intent =new Intent(com.example.dream_cream.UI.UserProfileActivity.this, com.example.dream_cream.UI.CategoryActivity.class);
    ...
    private void CheckLogout(){
        AlertDialog.Builder checkAlert = new AlertDialog.Builder(com.example.dream_cream.UI.UserProfileActivity.this);
        checkAlert.setMessage("Do you want to Logout?")
                .setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                FirebaseAuth.getInstance().signOut();
                Intent intent=new Intent(com.example.dream_cream.UI.UserProfileActivity.this, com.example.dream_cream.UI.loginActivity.class);
                startActivity(intent);
                finish();
            }
